...
namespace ThingsGateway.Foundation.Rpc.TouchRpc
{
    ...
    public interface ITouchRpcService : IRpcParser, ITargetRpcActor
    {
        ...
        void Send(string targetId, short protocol, byte[] buffer, int offset, int length);
        ...
        /// <exception cref="ClientNotFindException">未找到ID对应的客户端</exception>
        /// <exception cref="Exception">其他异常</exception>
        Task SendAsync(string targetId, short protocol, byte[] buffer, int offset, int length);
    }
}