...
public static class ReadWriteHelpers
{
    ...
    /// <summary>
    /// 根据<see cref="ThingsGateway.Foundation.OperResult.IsSuccess"/>执行action
    /// </summary>
    ...
    public static void PraseStructContent(
              ...
              IThingsGatewayBitConverter deviceByteConverter, int startIndex = 0)
    {
        foreach (DeviceVariable organizedVariable in values)
        {
            ...
            IThingsGatewayBitConverter byteConverter = ByteConverterHelper.GetTransByAddress(ref address, deviceValue.ThingsGatewayBitConverter);
