...
export const SysJobApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSysJobGetJobClusterListGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/sysJob/getJobClusterList`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiSysJobGetJobPageGet: async (jobId?: string, description?: string, page?: number, pageSize?: number, field?: string, order?: string, descStr?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/sysJob/getJobPage`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiSysJobGetJobTriggerListGet: async (jobId?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/sysJob/getJobTriggerList`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const SysJobApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobClusterListGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListSysJobCluster>>> {
            const localVarAxiosArgs = await SysJobApiAxiosParamCreator(configuration).apiSysJobGetJobClusterListGet(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobPageGet(jobId?: string, description?: string, page?: number, pageSize?: number, field?: string, order?: string, descStr?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultSqlSugarPagedListJobOutput>>> {
            const localVarAxiosArgs = await SysJobApiAxiosParamCreator(configuration).apiSysJobGetJobPageGet(jobId, description, page, pageSize, field, order, descStr, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobTriggerListGet(jobId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListSysJobTrigger>>> {
            const localVarAxiosArgs = await SysJobApiAxiosParamCreator(configuration).apiSysJobGetJobTriggerListGet(jobId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SysJobApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobClusterListGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysJobCluster>> {
            return SysJobApiFp(configuration).apiSysJobGetJobClusterListGet(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 获取作业分页列表
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobPageGet(jobId?: string, description?: string, page?: number, pageSize?: number, field?: string, order?: string, descStr?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultSqlSugarPagedListJobOutput>> {
            return SysJobApiFp(configuration).apiSysJobGetJobPageGet(jobId, description, page, pageSize, field, order, descStr, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 获取触发器列表
         ...
         * @throws {RequiredError}
         */
        async apiSysJobGetJobTriggerListGet(jobId?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysJobTrigger>> {
            return SysJobApiFp(configuration).apiSysJobGetJobTriggerListGet(jobId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary 暂停所有作业
...
export class SysJobApi extends BaseAPI {
     ...
     * @memberof SysJobApi
     */
    public async apiSysJobGetJobClusterListGet(options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminResultListSysJobCluster>> {
        return SysJobApiFp(this.configuration).apiSysJobGetJobClusterListGet(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary 获取作业分页列表
     ...
     * @memberof SysJobApi
     */
    public async apiSysJobGetJobPageGet(jobId?: string, description?: string, page?: number, pageSize?: number, field?: string, order?: string, descStr?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminResultSqlSugarPagedListJobOutput>> {
        return SysJobApiFp(this.configuration).apiSysJobGetJobPageGet(jobId, description, page, pageSize, field, order, descStr, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary 获取触发器列表
     ...
     * @memberof SysJobApi
     */
    public async apiSysJobGetJobTriggerListGet(jobId?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminResultListSysJobTrigger>> {
        return SysJobApiFp(this.configuration).apiSysJobGetJobTriggerListGet(jobId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary 暂停所有作业
